...
public class Player{
    ...
    /**
     * Team IR edits:
     * Clock object - getTicks()
     * NFLTeam object - getPlayerByPos(positionWithBall)
     * PlayerStat object - updateMessage()
     * 
     */
         ...
         if (runPlay){
            //add on a certain amount of yards
             if ((overallSkill + speed + strength) > 210){
                ...
                msg = 2;
                try{
                stats.updateMessage(msg, clock.getTicks(), yardage, (positionOfBall + yardage), team.getPlayerByPos(positionWithBall));//this should not compile until shared and commited with Stats message class
            }
            catch(Exception e){
